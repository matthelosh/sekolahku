            ...
            <div class="card-block">
                <div class="row m-b-25">
                    <div class="col-auto p-r-0">
                        <div class="u-img">
                            <img src="{{ asset('vendors/adminty/assets/images/breadcrumb-bg.jpg') }}" alt="user image" class="img-radius cover-img">
                            <img src="{{ asset('vendors/adminty/assets/images/avatar-2.jpg') }}" alt="user image" class="img-radius profile-img">
                        </div>
                    </div>
                    <div class="col">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="b-none">
                                                ...
                                                <img src="{{ asset('vendors/adminty/assets/images/avatar-2') }}.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
