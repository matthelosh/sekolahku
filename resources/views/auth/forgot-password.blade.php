...
<body style="height: 100vh;">
        ...
        <div class="row align-items-center h-100" >
            <div class="col-sm-4 m-auto" >
                <div class="card my-auto">
                    ...
                    <div class="card-body">
                        <h4 class="card-title"><i class="feather icon-lock"></i> Lupa Password</h4>
                        <form action="{{ route('forgot-password') }}" method="POST" class="form" id="login-form">
                            @csrf()
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12">
                                    <button class="btn btn-primary btn-block">Minta Link Reset Password</button>
                                </div>
                                <div class="col-sm-12">
                                    <a href="{{ route('login') }}"><i class="feather icon-arrow-left"></i> Kembali</a>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        @if (session('status'))
            <script>
                new PNotify({
                        title: 'Info',
                        text: 'Link reset password dikirimkan ke Email Anda. Silahkan Cek Email untuk mengatur ulang password.',
                        type: 'info'
                    })
            </script>
        @endif
